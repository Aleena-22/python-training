...
# Saving Employees to JSON
save_to_json(employees, json_path =  r"D:\py_training\python-training\292135-hackathon2\employeeList.json")

# Loading Employees from JSON

print("\n📂 Loaded Data from JSON:")

loaded_emps = load_from_json(json_path=r"D:\py_training\python-training\292135-hackathon2\employeeList.json")
